...
export default function ReportsPage() {
  ...
  const exportToCSV = () => {
    // Create CSV content
    const headers = ["Date", "Transaction ID", "Customer", "Items", "Payment Method", "Amount"]
    ...
    filteredSales.forEach((sale) => {
      const row = [
        ...
        sale.paymentMethod === "credit" ? "Credit Card" : sale.paymentMethod === "cash" ? "Cash" : "Mobile Payment",
        ...
        <body>
          ...
          <div class="report-header">
            ...
            <div>
              ...
              <p><strong>Total Revenue:</strong> $${filteredSales.reduce((sum, sale) => sum + sale.total, 0).toFixed(2)}</p>
            </div>
          </div>
          ${printContent}
        </body>
