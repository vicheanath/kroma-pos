...
import { usePosData, type Product, type CartItem, type Sale } from "@/components/pos-data-provider"
...
export default function SalesPage() {
  ...
  // Calculate discount
  const discountAmount = discountType === "percentage" ? cartSubtotal * (discountValue / 100) : discountValue
  ...
  const applyDiscount = () => {
    ...
    if (discountValue > 0) {
      toast({
        ...
        description: `${discountType === "percentage" ? discountValue + "%" : "$" + discountValue.toFixed(2)} discount applied to cart.`,
      })
    }
  }
    ...
    <div className="flex h-full flex-col md:flex-row gap-4">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        >
          ...
          <TabsContent value="all" className="flex-1 overflow-auto mt-0 data-[state=active]:flex-1">
                    ...
                    >
                      ...
                      <CardFooter className="p-3 pt-0 flex gap-2">
                        ...
                        >
                          ...
                          {quickAddAmount ? `Add ${quickAddAmount}` : "Quick Add"}
                        </Button>
                      </CardFooter>
                    </Card>
                  </motion.div>
          ...
          <TabsContent value="popular" className="flex-1 overflow-auto mt-0 data-[state=active]:flex-1">
            <div className="h-full overflow-auto p-1">
              <motion.div
                className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4"
                variants={containerVariants}
          ...
          <TabsContent value="recent" className="flex-1 overflow-auto mt-0 data-[state=active]:flex-1">
            <div className="h-full overflow-auto p-1">
              <motion.div
                className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4"
                variants={containerVariants}
          ...
          <TabsContent value="favorites" className="flex-1 overflow-auto mt-0 data-[state=active]:flex-1">
            <div className="h-full overflow-auto p-1">
              <div className="flex flex-col items-center justify-center h-40 text-center">
                <BarChart className="h-12 w-12 text-muted-foreground mb-2" />
                <p className="text-muted-foreground">Favorites feature coming soon</p>
      ...
      <div className="w-full md:w-96 flex flex-col border rounded-lg bg-card shadow-sm">
        ...
        <div className="flex-1 overflow-auto">
          <AnimatePresence>
            {cart.length > 0 ? (
              <motion.div className="divide-y" variants={containerVariants} initial="hidden" animate="show">
                {cart.map((item) => (
                  <motion.div
                    key={item.product.id}
      ...
      <Dialog open={isDiscountDialogOpen} onOpenChange={setIsDiscountDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>Add a discount to the current sale.</DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isNotesDialogOpen} onOpenChange={setIsNotesDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>Add notes to this sale for reference.</DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isCustomerDialogOpen} onOpenChange={setIsCustomerDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>Add customer details to this sale.</DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={isCheckoutOpen} onOpenChange={setIsCheckoutOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            ...
            <DialogDescription>Complete your purchase by selecting a payment method.</DialogDescription>
          </DialogHeader>
      ...
      {completedSale && (
        <InvoicePrint sale={completedSale} isOpen={isInvoiceOpen} onClose={() => setIsInvoiceOpen(false)} />
      )}
    </div>
  )
}
