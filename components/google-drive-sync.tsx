...
import { Upload, Download, LogOut, LogIn, Loader2, CheckCircle2, AlertCircle } from "lucide-react";
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your data has been successfully synced from Google Drive. Please refresh the page.",
      });
      ...
      toast({
        ...
        description: error.message || "Failed to download data from Google Drive.",
        variant: "destructive",
      });
    } finally {
        ...
        <CardContent>
          <div className="space-y-4">
            <Alert>
              ...
              <AlertDescription>
                You need to sign in with Google to enable cloud sync functionality.
              </AlertDescription>
            </Alert>
    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {(isUploading || isDownloading) && (
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground text-center">
              {isUploading ? "Uploading to Google Drive..." : "Downloading from Google Drive..."}
            </p>
          </div>
        )}
        ...
        <Alert>
          ...
          <AlertDescription>
            Your data will be stored in a folder named "Kroma POS Backups" in your Google Drive.
          </AlertDescription>
        </Alert>
      </CardContent>
    </Card>
