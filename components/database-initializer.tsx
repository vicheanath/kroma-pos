    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center p-4">
        <div className="flex flex-col items-center space-y-4 text-center">
          ...
          <p className="text-muted-foreground">Please wait while we set up your POS system...</p>
        </div>
      </div>
    )
  }
      ...
      <div className="flex min-h-screen flex-col items-center justify-center p-4">
        <div className="w-full max-w-md space-y-6">
          <Alert variant="destructive">
            ...
            <AlertDescription>There was a problem initializing the database: {error}</AlertDescription>
          </Alert>

          <div className="flex flex-col space-y-2">
            <Button onClick={initializeDb} className="w-full" disabled={isLoading}>
              ...
              onClick={async () => {
                try {
                  ...
                  if (typeof window !== "undefined" && "indexedDB" in window) {
                    ...
                    const request = window.indexedDB.deleteDatabase("pos_system_db")
    ...
    return (
      <div className="flex min-h-screen flex-col items-center justify-center p-4">
        <div className="flex flex-col items-center space-y-4 text-center">
          ...
          <p className="text-muted-foreground">The database could not be initialized. Please try again.</p>
