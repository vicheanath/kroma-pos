...
export async function uploadToGoogleDrive(
  ...
  try {
    ...
    // Note: This function expects data to be passed from the API route
    // The actual export happens client-side and data is sent to this function
    // For now, we'll need to export data in the API route instead
